 	...
 	<h4 class="mt-4 text-white">${usuarios.nombre}</h4>
		<div class="row">
			<div class="col-md-6">
				...
				<!-- AÑADIR BOTON DE OPCIONES DE ADMIN  
				- DAR DE ALTA, MODIFICAR Y BORRAR PRODUCTOS
				- DAR DE ALTA USUARIOS CON EL ROL DE ADMINISTRADOR
				- VER LOS PEDIDOS DIARIOS DE LOS CLIENTES PARA EMPAQUETAR
				- VER LOS DATOS DE UN CLIENTE: PEDIDOS E IMPORTE
				-->
